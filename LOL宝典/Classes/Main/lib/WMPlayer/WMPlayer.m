...
- (void)setURLString:(NSString *)URLString{
    ...
    if (self.closeBtnStyle==CloseBtnStylePop) {
        [_closeBtn setImage:[UIImage imageNamed:WMPlayerSrcName(@"video_back")] ?: [UIImage imageNamed:WMPlayerFrameworkSrcName(@"video_back")] forState:UIControlStateNormal];
        [_closeBtn setImage:[UIImage imageNamed:WMPlayerSrcName(@"video_back")] ?: [UIImage imageNamed:WMPlayerFrameworkSrcName(@"video_back")] forState:UIControlStateSelected];
